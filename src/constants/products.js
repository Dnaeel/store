export const products = [
    {
        id:1,
        name:"Наушники Xiaomi Mi Bluetooth Neckband Earphones (LYXQEJ01JY)",
    ...
    {
        id:2,
        name:"Чемодан Xiaomi 90 points suitcase 26″ (1203)",
    ...
    {
        id:3,
        name:"Антибактериальный фильтр для очистителя воздуха Xiaomi Mi Air Purifier (MCR-FLG/FLA))",
    ...
    {
        id:4,
        name:"Триммер-машинка для стрижки волос Xiaomi ENCHEN Hummingbird Hair Clipper (MK525-052)",
